                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item active" href="#">Por nombre</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item " href="/buscarubicacion">Por ubicación</a>
                            </div>
                        </li>
                    ...
                    {store.buscarRestaurant !== "" ?
                        data
                            .filter((restaurant, i) => {
                                ...
                                return (name.includes(store.buscarRestaurant))
                            })
                            .map((restaurant, i) => {
                                return (
                        ...
                        :
                        (
                            <div className="mt-4 mb-4 pl-3" id="errorNombre">
                                <h5>No hay restaurantes con ese nombre, busque nuevamente</h5>
                            </div>
                        )
                    }
                </div>
